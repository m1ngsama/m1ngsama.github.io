...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zi(e,t,n){let r=new Float32Array(Li),i=new H(0,1,0);return new Z({name:`SphericalGaussianBlur`,defines:{n:Li,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ea(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qi(){return new Z({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ea(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $i(){return new Z({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ea(),fragmentShader:`
	...
	`}var ta=class extends Je{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=yo(i,i.VERTEX_SHADER,y),S=yo(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=To(i,x,`vertex`),n=To(i,S,`fragment`);I(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Hs=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Us=new ri(-1,1,1,-1,0,1),Ws=new class extends Dn{constructor(){super(),this.setAttribute(`position`,new hn([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new hn([0,2,0,0,2,0],2))}},Gs=class{constructor(e){this._mesh=new Xn(Ws,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Us)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Ks=class extends Hs{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Z?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Dr.clone(e.uniforms),this.material=new Z({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Gs(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},qs=class extends Hs{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Js=class extends Hs{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Ys=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new V);this._width=n.width,this._height=n.height,t=new Je(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:u}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Ks(Vs),this.copyPass.material.blending=0,this.timer=new ci}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}qs!==void 0&&(r instanceof qs?n=!0:r instanceof Js&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new V);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Xs={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ec={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},tc={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},ic=class e extends Hs{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new V(256,256):new V(e.x,e.y),this.clearColor=new X(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Je(i,a,{type:u}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Je(i,a,{type:u});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Je(i,a,{type:u});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=rc;this.highPassUniforms=Dr.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Z({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new V(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new H(1,1,1),new H(1,1,1),new H(1,1,1),new H(1,1,1),new H(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Dr.clone(Vs.uniforms),this.blendMaterial=new Z({uniforms:this.copyUniforms,vertexShader:Vs.vertexShader,fragmentShader:Vs.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new X,this._oldClearAlpha=1,this._basic=new Rn,this._fsQuad=new Gs(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new V(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Z({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new V(.5,.5)},direction:{value:new V(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};ic.BlurDirectionX=new V(1,0),ic.BlurDirectionY=new V(0,1);var ac={uniforms:{tDiffuse:{value:null},uTime:{value:0},uPulse:{value:0},uProgress:{value:0},uAspect:{value:1},uVelocity:{value:0},uPointer:{value:new V}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},oc=class{renderer;scene;camera;composer;renderPass;bloom;cosmology;smaa;output;renderScale;constructor(e,t,n,r,i){if(this.renderer=e,this.scene=t,this.camera=n,this.renderScale=r===`high`?1:r===`medium`?.88:1,r===`low`||i)return;this.composer=new Ys(e),this.renderPass=new Qs(t,n),this.composer.addPass(this.renderPass);let a=r===`high`;this.bloom=new ic(new V(window.innerWidth,window.innerHeight),a?.25:.19,a?.29:.22,a?.88:.91),this.composer.addPass(this.bloom),this.cosmology=new Ks(ac),this.composer.addPass(this.cosmology),this.smaa=new nc,this.composer.addPass(this.smaa),this.output=new Zs,this.composer.addPass(this.output)}update(e,t,n,r,i){this.cosmology&&(this.cosmology.uniforms.uTime.value=e,this.cosmology.uniforms.uPulse.value=t,this.cosmology.uniforms.uProgress.value=n,this.cosmology.uniforms.uAspect.value=window.innerWidth/Math.max(window.innerHeight,1),this.cosmology.uniforms.uVelocity.value=i,this.cosmology.uniforms.uPointer.value.copy(r))}render(e){this.composer?this.composer.render(e):this.renderer.render(this.scene,this.camera)}setPixelRatio(e){this.composer?.setPixelRatio(e*this.renderScale)}setSize(e,t){this.composer?.setSize(e,t)}getRenderScale(){return this.composer?this.renderScale:1}dispose(){this.renderPass?.dispose(),this.bloom?.dispose(),this.cosmology?.dispose(),this.smaa?.dispose(),this.output?.dispose(),this.composer?.dispose()}},sc=`
  varying vec2 vUv;
...
`;function cc(e){return`
  ...
  float fbm(vec2 p) {
    float value = 0.0;
    float amplitude = 0.5;
    for (int i = 0; i < ${e===`high`?5:e===`medium`?4:3}; i++) {
...
`}var lc=class extends Xn{constructor(e){let t=new Z({uniforms:{uTime:{value:0},uPresence:{value:0},uPulse:{value:0}},vertexShader:sc,fragmentShader:cc(e),transparent:!0,depthWrite:!1,depthTest:!0,side:2,blending:2,toneMapped:!0});super(new br(8.9,8.9),t),t.forceSinglePass=!0,this.name=`Accretion Memory`,this.position.z=-.3,this.rotation.x=1.36,this.rotation.z=-.24,this.renderOrder=1,this.frustumCulled=!1}update(e,t,n){this.visible=t>.003,this.material.uniforms.uTime.value=e,this.material.uniforms.uPresence.value=t,this.material.uniforms.uPulse.value=n,this.rotation.z=-.24-e*.006,this.scale.setScalar(.92+t*.08+Math.sin(e*.21)*.004)}dispose(){this.geometry.dispose(),this.material.dispose()}},uc=class extends Xn{constructor(e){let t=e===`high`?4:e===`medium`?3:2,n=new Z({uniforms:{uTime:{value:0},uProgress:{value:0},uPulse:{value:0},uPointer:{value:new V},uAspect:{value:window.innerWidth/Math.max(window.innerHeight,1)}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = vec4(position.xy, 1.0, 1.0);
      ...
      `,depthWrite:!1,depthTest:!1,toneMapped:!0});super(new br(2,2),n),this.name=`The Observable Dark`,this.renderOrder=-100,this.frustumCulled=!1}update(e,t,n,r){this.material.uniforms.uTime.value=e,this.material.uniforms.uProgress.value=t,this.material.uniforms.uPulse.value=r,this.material.uniforms.uAspect.value=window.innerWidth/Math.max(window.innerHeight,1),this.material.uniforms.uPointer.value.copy(n)}dispose(){this.geometry.dispose(),this.material.dispose()}},dc=`
...
`;function fc(e){let t=e===`high`?320:e===`medium`?220:144,n=e===`high`?80:e===`medium`?56:32,r=(t+1)*(n+1),i=(t+1)*4,a=r*2+i,o=new Float32Array(a*3),s=new Float32Array(a*2),c=new Float32Array(a),l=new Float32Array(a),u=[];for(let e=0;e<2;e+=1){let i=e===0?1:-1,a=e*r;for(let e=0;e<=n;e+=1)for(let r=0;r<=t;r+=1){let o=a+e*(t+1)+r;s[o*2]=r/t,s[o*2+1]=e/n*2-1,c[o]=i}}for(let e=0;e<2;e+=1){let i=e*r;for(let r=0;r<n;r+=1)for(let n=0;n<t;n+=1){let a=i+r*(t+1)+n,o=a+1,s=a+t+1,c=s+1;e===0?u.push(a,s,o,o,s,c):u.push(a,o,s,o,c,s)}}let d=r*2;for(let e of[-1,1]){let n=d;for(let n=0;n<=t;n+=1)for(let r=0;r<2;r+=1){let i=d++;s[i*2]=n/t,s[i*2+1]=e,c[i]=r===0?1:-1,l[i]=e}for(let r=0;r<t;r+=1){let t=n+r*2,i=t+1,a=t+2,o=t+3;e<0?u.push(t,i,a,i,o,a):u.push(t,a,i,i,a,o)}}let f=new Dn;return f.setAttribute(`position`,new fn(o,3)),f.setAttribute(`aParam`,new fn(s,2)),f.setAttribute(`aLayer`,new fn(c,1)),f.setAttribute(`aEdge`,new fn(l,1)),f.setIndex(u),f.boundingSphere=new yn(new H,7),f}var pc=`
  uniform float uTime;
  uniform float uProgress;
  uniform float uPulse;
...
`,hc=class extends Xn{constructor(e){let t=new Z({uniforms:{uTime:{value:0},uProgress:{value:0},uPulse:{value:0},uPointer:{value:new V},uMobile:{value:+(e===`low`)}},vertexShader:pc,fragmentShader:mc,side:2,depthWrite:!0,depthTest:!0,toneMapped:!0});super(fc(e),t),this.name=`One Surface Cosmology`,this.frustumCulled=!1}update(e,t,n,r,i){this.material.uniforms.uTime.value=e,this.material.uniforms.uProgress.value=t,this.material.uniforms.uPulse.value=r,this.material.uniforms.uMobile.value=+!!i,this.material.uniforms.uPointer.value.copy(n)}dispose(){this.geometry.dispose(),this.material.dispose()}},gc=`
  varying vec2 vUv;
...
`;function _c(e){return`
    ...
    float fbm(vec2 p) {
      float value = 0.0;
      float amplitude = 0.5;
      for (int octave = 0; octave < ${e===`high`?5:e===`medium`?4:3}; octave++) {
        value += noise2(p) * amplitude;
  ...
  `}var vc=class extends Xn{constructor(e){let t=new Z({uniforms:{uTime:{value:0},uPresence:{value:0},uEnergy:{value:0}},vertexShader:gc,fragmentShader:_c(e),transparent:!0,depthWrite:!1,depthTest:!0,blending:1,toneMapped:!0});super(new br(13.2,13.2),t),this.name=`Absorptive Galactic Medium`,this.position.z=-.055,this.renderOrder=-2,this.frustumCulled=!1,this.visible=!1}update(e,t,n){this.visible=t>.002,this.material.uniforms.uTime.value=e,this.material.uniforms.uPresence.value=t,this.material.uniforms.uEnergy.value=n}dispose(){this.geometry.dispose(),this.material.dispose()}},yc={high:72e3,medium:32e3,low:14e3};function bc(e){let t=e>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function xc(e){return Me.clamp((e()+e()+e()+e()-2)*.5,-1,1)}function Sc(e){let t=yc[e],n=new Float32Array(t*3),r=new Float32Array(t*4),i=new Float32Array(t*4),a=new Float32Array(t),o=bc(1831956071);for(let e=0;e<t;e+=1){let t=e*4,n=o(),s=n<.15?0:n<.55?1:n<.8?2:n<.95?3:4,c=Math.floor(o()*2),l=o()**1.05;l=s===0?o()**2.7*.32:s===1||s===4?.035+o()**.92*.965:s===2?Math.sqrt(o()):o()**.48*1.12,r[t]=l,r[t+1]=c/2,r[t+2]=xc(o),r[t+3]=xc(o),a[e]=s,i[t]=o(),i[t+1]=o(),i[t+2]=o(),i[t+3]=o()}let s=new Dn;return s.setAttribute(`position`,new fn(n,3)),s.setAttribute(`aGalaxy`,new fn(r,4)),s.setAttribute(`aSeed`,new fn(i,4)),s.setAttribute(`aPopulation`,new fn(a,1)),s.boundingSphere=new yn(new H,7.25),s}var Cc=`
  uniform float uTime;
...
`,Tc=class extends pr{volume;constructor(e){let t=e===`high`?1:e===`medium`?.52:0,n=e===`high`?1.6:e===`medium`?1.35:1.1,r=new Z({uniforms:{uTime:{value:0},uGalaxy:{value:0},uHorizon:{value:0},uEnergy:{value:0},uPointer:{value:new V},uPixelRatio:{value:Math.min(window.devicePixelRatio,n)},uQuality:{value:t}},vertexShader:Cc,fragmentShader:wc,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,toneMapped:!0});super(Sc(e),r),this.volume=new vc(e),this.add(this.volume),this.name=`Layered Spiral Galaxy`,this.visible=!1,this.frustumCulled=!1,this.renderOrder=0}update(e,t,n,r){this.material.uniforms.uTime.value=e,this.material.uniforms.uGalaxy.value=t.galaxy,this.material.uniforms.uHorizon.value=t.horizon,this.material.uniforms.uEnergy.value=r,this.material.uniforms.uPointer.value.copy(n),this.volume.update(e,t.galaxy*(1-t.horizon),r),this.visible=Math.max(t.galaxy,t.horizon)>.002}setPixelRatio(e){this.material.uniforms.uPixelRatio.value=e}dispose(){this.geometry.dispose(),this.material.dispose(),this.volume.dispose()}};function Ec(e){let t=e>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function Dc(e){let t=e===`high`?2800:e===`medium`?1200:240,n=new Float32Array(t*3),r=new Float32Array(t*2),i=new Float32Array(t*3),a=Ec(1831956071);for(let e=0;e<t;e+=1){let t=a()**.82,n=(a()+a()+a()-1.5)/1.5;r[e*2]=t,r[e*2+1]=Me.clamp(n*.96,-1,1),i[e*3]=a(),i[e*3+1]=a(),i[e*3+2]=a()}let o=new Dn;return o.setAttribute(`position`,new fn(n,3)),o.setAttribute(`aParam`,new fn(r,2)),o.setAttribute(`aSeed`,new fn(i,3)),o.boundingSphere=new yn(new H,8),o}var Oc=`
  uniform float uTime;
  uniform float uProgress;
  uniform float uPulse;
  uniform float uPixelRatio;
...
`,Ac=class extends pr{constructor(e){let t=new Z({uniforms:{uTime:{value:0},uProgress:{value:0},uPulse:{value:0},uPointer:{value:new V},uPixelRatio:{value:Math.min(window.devicePixelRatio,e===`high`?1.6:1.3)},uMobile:{value:+(e===`low`)}},vertexShader:Oc,fragmentShader:kc,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,toneMapped:!0});super(Dc(e),t),this.name=`Surface-born Stars`,this.frustumCulled=!1,this.renderOrder=4}update(e,t,n,r,i){this.material.uniforms.uTime.value=e,this.material.uniforms.uProgress.value=t,this.material.uniforms.uPulse.value=r,this.material.uniforms.uMobile.value=+!!i,this.material.uniforms.uPointer.value.copy(n)}setPixelRatio(e){this.material.uniforms.uPixelRatio.value=e}dispose(){this.geometry.dispose(),this.material.dispose()}};function jc(e){let t=Me.clamp(e,0,1);return t*t*t*(t*(t*6-15)+10)}function Mc(e,t,n){return jc((n-e)/(t-e))}function Nc(e,t,n,r,i){return Mc(e,t,i)*(1-Mc(n,r,i))}function Pc(e,t){let n=e.at(-1);if(t>=n.at)return{position:n.position.clone(),target:n.target.clone(),fov:n.fov};let r=e.findIndex(e=>e.at>=t),i=Math.max(r,1),a=e[i-1],o=e[i],s=Me.clamp((t-a.at)/(o.at-a.at),0,1),c=e[Math.max(i-2,0)],l=e[Math.min(i+1,e.length-1)],u=(e,t,n,r)=>{let i=s*s,a=i*s,o=(n-e)*.5,c=(r-t)*.5;return(2*a-3*i+1)*t+(-2*a+3*i)*n+(a-2*i+s)*o+(a-i)*c},d=(e,t,n,r)=>new H(u(e.x,t.x,n.x,r.x),u(e.y,t.y,n.y,r.y),u(e.z,t.z,n.z,r.z));return{position:d(c.position,a.position,o.position,l.position),target:d(c.target,a.target,o.target,l.target),fov:u(c.fov,a.fov,o.fov,l.fov)}}var Fc=[{at:0,position:new H(.78,-.16,3.72),target:new H(.24,.02,-.34),fov:31},{at:.26,position:new H(-.42,.28,10.9),target:new H(-.34,.05,0),fov:33},{at:.48,position:new H(1.58,.92,6.62),target:new H(-.12,.04,0),fov:34},{at:.69,position:new H(-2.86,1.12,6.08),target:new H(-.3,.09,0),fov:35},{at:.82,position:new H(-1.08,.4,7.76),target:new H(-.08,.02,0),fov:34},{at:1,position:new H(.12,-.04,9.72),target:new H(.03,0,0),fov:32}],Ic=[{at:0,position:new H(.2,-.08,4.08),target:new H(.06,0,-.26),fov:39},{at:.26,position:new H(-.22,.16,11.5),target:new H(-.24,.04,0),fov:39},{at:.48,position:new H(.92,.58,8.32),target:new H(-.08,.03,0),fov:40},{at:.69,position:new H(-1.42,.72,8.08),target:new H(-.16,.05,0),fov:41},{at:.82,position:new H(-.5,.22,8.72),target:new H(-.04,.02,0),fov:39},{at:1,position:new H(.04,0,13.18),target:new H(.02,0,0),fov:36}];function Lc(e,t){let n=Me.clamp(e,0,1);return{...Pc(t?Ic:Fc,n),veil:1-Mc(.105,.295,n),world:Nc(.105,.295,.39,.535,n),orbit:Nc(.39,.535,.565,.745,n),galaxy:Nc(.565,.745,.865,.98,n),horizon:Mc(.865,.98,n)}}var Rc=Math.PI*2;function zc(e){let t=e>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}function Bc(e){let t=e===`high`?4200:e===`medium`?2400:900,n=new Float32Array(t*3),r=new Float32Array(t*4),i=new Float32Array(t*2),a=zc(2135587861);for(let e=0;e<t;e+=1){let t=a()**.76,o=a(),s=a(),c=a()**4.2,l=-3.1-t*16.8,u=3.4+t*11.2,d=0,f=0,p=0;if(o<.7){let e=Math.floor(a()*11),n=a()*Rc+e*.571,r=1.72+a()**.68*u+Math.sin(n*(2+e%4)+e*1.71)*(.08+t*.2)+(a()-.5)*.13,i=Math.log2(r+1)*(.085+e%3*.025)+t*.16;d=Math.cos(n+i)*r*(1.04+e%2*.08),f=Math.sin(n)*r*(.66+e%4*.035),p=0}else if(o<.93){let e=Math.floor(a()*5),n=a(),r=e*Rc/5+n*Rc*1.38+t*.34,i=1.36+n**.72*u,o=(a()+a()-1)*(.08+i*.018);d=Math.cos(r)*(i+o)*1.12,f=Math.sin(r)*(i+o)*.7,p=1}else{let e=a()*Rc,t=2.15+Math.sqrt(a())*u;d=Math.cos(e)*t*1.16,f=Math.sin(e)*t*.73,p=2}let m=e*3;n[m]=d,n[m+1]=f,n[m+2]=l;let h=e*4;r[h]=t,r[h+1]=s,r[h+2]=c,r[h+3]=p;let g=e*2;i[g]=a(),i[g+1]=a()}let o=new Dn;return o.setAttribute(`position`,new fn(n,3)),o.setAttribute(`aData`,new fn(r,4)),o.setAttribute(`aSeed`,new fn(i,2)),o.boundingSphere=new yn(new H(0,0,-10.5),25),o}var Vc=`
  uniform float uTime;
  uniform float uProgress;
...
`,Uc=class extends pr{constructor(e){let t=new Z({uniforms:{uTime:{value:0},uProgress:{value:0},uWorld:{value:0},uOrbit:{value:0},uGalaxy:{value:0},uHorizon:{value:0},uEnergy:{value:0},uPointer:{value:new V},uPixelRatio:{value:Math.min(window.devicePixelRatio,e===`high`?1.65:e===`medium`?1.4:1.2)}},vertexShader:Vc,fragmentShader:Hc,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,toneMapped:!0});super(Bc(e),t),this.name=`Lensed Deep Field`,this.renderOrder=-20,this.frustumCulled=!1}update(e,t,n,r,i){this.material.uniforms.uTime.value=e,this.material.uniforms.uProgress.value=t,this.material.uniforms.uWorld.value=n.world,this.material.uniforms.uOrbit.value=n.orbit,this.material.uniforms.uGalaxy.value=n.galaxy,this.material.uniforms.uHorizon.value=n.horizon,this.material.uniforms.uEnergy.value=i,this.material.uniforms.uPointer.value.copy(r)}setPixelRatio(e){this.material.uniforms.uPixelRatio.value=e}dispose(){this.geometry.dispose(),this.material.dispose()}},Wc=`
  varying vec3 vWorldPosition;
...
`,Kc=class extends wt{coreGeometry;coreMaterial;core;atmosphereGeometry;atmosphereMaterial;atmosphere;constructor(e){super(),this.name=`The Unseen Core`;let t=e===`high`?96:e===`medium`?72:48,n=e===`high`?64:e===`medium`?48:32;this.coreGeometry=new xr(1.82,t,n),this.coreMaterial=new Rn({color:1,toneMapped:!1}),this.core=new Xn(this.coreGeometry,this.coreMaterial),this.core.renderOrder=2,this.atmosphereGeometry=new xr(2.15,t,n),this.atmosphereMaterial=new Z({uniforms:{uTime:{value:0},uPresence:{value:0},uPulse:{value:0},uPointer:{value:new V}},vertexShader:Wc,fragmentShader:Gc,transparent:!0,depthWrite:!1,depthTest:!0,side:1,blending:2,toneMapped:!0}),this.atmosphere=new Xn(this.atmosphereGeometry,this.atmosphereMaterial),this.atmosphere.renderOrder=3,this.add(this.core,this.atmosphere)}update(e,t,n,r){let i=t.world*.96+t.horizon*.72;this.core.visible=i>.015,this.core.scale.setScalar(Math.max(i,.001)),this.core.rotation.y=e*.018;let a=t.world;this.atmosphere.visible=a>.005;let o=t.world;this.atmosphere.scale.setScalar(Math.max(o,.001)*(1.035+r*.004)),this.atmosphereMaterial.uniforms.uTime.value=e,this.atmosphereMaterial.uniforms.uPresence.value=a,this.atmosphereMaterial.uniforms.uPulse.value=r,this.atmosphereMaterial.uniforms.uPointer.value.copy(n)}dispose(){this.coreGeometry.dispose(),this.coreMaterial.dispose(),this.atmosphereGeometry.dispose(),this.atmosphereMaterial.dispose()}},qc=class extends wt{quality;backdrop;starfield;galaxy;surface;particles;world;accretion;matter=new wt;constructor(e){super(),this.quality=e,this.name=`One Surface Cosmology`,this.starfield=new Uc(e),this.backdrop=new uc(e),this.galaxy=new Tc(e),this.surface=new hc(e),this.particles=new Ac(e),this.world=new Kc(e),this.accretion=new lc(e),this.matter.name=`The Only Matter`,this.matter.add(this.surface,this.world,this.particles),this.galaxy.rotation.set(.94,.12,-.32),this.galaxy.position.z=-.32,this.add(this.backdrop,this.starfield,this.galaxy,this.accretion,this.matter)}update(e,t,n,r,i,a,o=0){let s=Lc(r,i),c=Me.clamp(a+Math.abs(o)*.045,0,1),l=t===0?1:1-Math.exp(-t*3.25),u=Me.clamp(o*.006,-.08,.08),d=i?.82:1,f=Me.lerp(1,d,1-s.veil);this.matter.scale.setScalar(Me.lerp(this.matter.scale.x,f,l)),this.matter.rotation.x=Me.lerp(this.matter.rotation.x,s.orbit*.46+s.galaxy*.31+s.horizon*.035+n.y*.026,l),this.matter.rotation.y=Me.lerp(this.matter.rotation.y,s.world*.16+s.orbit*.62+s.galaxy*.18+s.horizon*.025+n.x*.04,l),this.matter.rotation.z=Me.lerp(this.matter.rotation.z,.045+s.orbit*.18+s.galaxy*(.24+e*.006)-s.horizon*.2+u,l);let p=Me.lerp(i?.49:.53,i?.61:.71,s.horizon);this.galaxy.scale.setScalar(p),this.galaxy.rotation.x=Me.lerp(.96,.035,s.horizon),this.galaxy.rotation.y=Me.lerp(.12,.025,s.horizon)+n.x*.018,this.galaxy.rotation.z=Me.lerp(-.32-e*.0035,-.155-e*.006,s.horizon),this.surface.update(e,r,n,c,i),this.particles.update(e,r,n,c,i),this.world.update(e,s,n,c),this.starfield.update(e,r,s,n,c),this.galaxy.update(e,s,n,c),this.accretion.update(e,s.horizon,c),this.backdrop.update(e,r,n,c)}setPixelRatio(e){this.starfield.setPixelRatio(e),this.galaxy.setPixelRatio(e),this.particles.setPixelRatio(e)}dispose(){this.surface.dispose(),this.particles.dispose(),this.world.dispose(),this.starfield.dispose(),this.galaxy.dispose(),this.accretion.dispose(),this.backdrop.dispose()}};function Jc(){let e=new ni(28,window.innerWidth/window.innerHeight,.08,40);return e.position.set(.52,-.06,2.72),e}function Yc(){let e=window.matchMedia(`(pointer: coarse)`).matches,t=navigator.hardwareConcurrency||4,n=window.innerWidth*window.innerHeight;return t<=4?`low`:window.innerWidth<720||e?t>=6&&n<22e5?`medium`:`low`:window.innerWidth<1240||t<=8||n>55e5?`medium`:`high`}function Xc(e,t=window.innerWidth,n=window.innerHeight){let r=e===`high`?1.65:e===`medium`?1.4:1.2,i=Math.sqrt((e===`high`?5e6:e===`medium`?3e6:15e5)/Math.max(t*n,1));return Math.max(.75,Math.min(window.devicePixelRatio,r,i))}function Zc(e,t){let n=new Bs({canvas:e,alpha:!1,antialias:t===`high`,depth:!0,stencil:!1,powerPreference:t===`high`?`high-performance`:`default`});return n.setClearColor(65795,1),n.setSize(window.innerWidth,window.innerHeight,!1),n.setPixelRatio(Xc(t)),n.outputColorSpace=O,n.toneMapping=4,n.toneMappingExposure=.88,n}var Qc=class{canvas;options;renderer;camera=Jc();scene=new Mt;pointer=new V;pointerTarget=new V;cameraTarget=new H;lookTarget=new H;quality;hero;composer;precisePointer=window.matchMedia(`(pointer: fine)`).matches;frameId=0;running=!1;paused=!1;destroyed=!1;scrollCurrent=0;scrollTarget=0;scrollVelocity=0;pulse=0;charge=0;pressing=!1;adaptiveScale=1;appliedPixelRatio=0;recoverySamples=0;resizeFrame=0;fpsStartedAt=performance.now();fpsFrames=0;elapsed=0;lastFrameTime=0;lastRenderTime=0;constructor(e,t){this.canvas=e,this.options=t,this.quality=Yc(),this.renderer=Zc(e,this.quality),this.scene.background=new X(65795),this.hero=new qc(this.quality),this.scene.add(this.hero),this.composer=new oc(this.renderer,this.scene,this.camera,this.quality,t.reducedMotion),this.updateScroll(),this.applyResize()}start(){this.destroyed||(this.bindEvents(),this.renderStaticFrame(),this.options.reducedMotion||(this.running=!0,this.lastFrameTime=performance.now(),this.lastRenderTime=this.lastFrameTime,this.frameId=requestAnimationFrame(this.tick)))}bindEvents(){window.addEventListener(`resize`,this.resize,{passive:!0}),window.addEventListener(`scroll`,this.updateScroll,{passive:!0}),document.addEventListener(`visibilitychange`,this.handleVisibility),this.canvas.addEventListener(`webglcontextlost`,this.handleContextLost),this.canvas.addEventListener(`webglcontextrestored`,this.handleContextRestored),this.options.reducedMotion||(window.addEventListener(`pointermove`,this.handlePointer,{passive:!0}),window.addEventListener(`pointerdown`,this.handleImpulse,{passive:!0}),window.addEventListener(`pointerup`,this.handleRelease,{passive:!0}),window.addEventListener(`pointercancel`,this.handleRelease,{passive:!0}),this.precisePointer&&document.documentElement.addEventListener(`pointerleave`,this.resetPointer))}handlePointer=e=>{this.pointerTarget.set((e.clientX/Math.max(window.innerWidth,1)-.5)*2,-(e.clientY/Math.max(window.innerHeight,1)-.5)*2)};handleImpulse=e=>{this.handlePointer(e),this.pressing=!0,this.charge=Math.max(this.charge,.16),this.pulse=Math.min(1,this.pulse+.24)};handleRelease=()=>{this.pressing&&(this.pressing=!1,this.pulse=Math.min(1,this.pulse+.22+this.charge*.7))};resetPointer=()=>{this.pointerTarget.set(0,0)};updateScroll=()=>{let e=Math.max(document.documentElement.scrollHeight-window.innerHeight,1);this.scrollTarget=Me.clamp(window.scrollY/e,0,1)};handleVisibility=()=>{document.hidden?(this.pressing=!1,this.stopLoop()):!this.options.reducedMotion&&!this.destroyed&&!this.paused&&(this.lastFrameTime=performance.now(),this.lastRenderTime=this.lastFrameTime,this.resetPerformanceSample(this.lastFrameTime),this.running=!0,this.frameId=requestAnimationFrame(this.tick))};handleContextLost=e=>{e.preventDefault(),this.stopLoop(),document.documentElement.classList.remove(`webgl-ready`),document.documentElement.classList.add(`webgl-fallback`)};handleContextRestored=()=>{this.destroyed||(document.documentElement.classList.remove(`webgl-fallback`),document.documentElement.classList.add(`webgl-ready`),this.resize(),this.renderStaticFrame(),!this.options.reducedMotion&&!this.paused&&!document.hidden&&(this.lastFrameTime=performance.now(),this.lastRenderTime=this.lastFrameTime,this.resetPerformanceSample(this.lastFrameTime),this.running=!0,this.frameId=requestAnimationFrame(this.tick)))};tick=e=>{if(!this.running||this.destroyed)return;this.frameId=requestAnimationFrame(this.tick);let t=this.quality===`low`?1e3/45:1e3/60;if(e-this.lastRenderTime<t-1)return;let n=Math.min(Math.max((e-this.lastFrameTime)/1e3,0),.2),r=Math.min(n,.05);this.lastFrameTime=e,this.lastRenderTime=e,this.elapsed+=n;let i=1-Math.exp(-n*4.2);this.pointer.lerp(this.pointerTarget,i);let a=this.scrollCurrent;this.scrollCurrent=Me.lerp(this.scrollCurrent,this.scrollTarget,i*.68);let o=n>0?(this.scrollCurrent-a)/n:0;this.scrollVelocity=Me.lerp(this.scrollVelocity,o,1-Math.exp(-n*8.5)),this.pressing?(this.charge=Math.min(1,this.charge+n*.72),this.pulse=Math.max(this.pulse,this.charge*.58)):(this.charge*=Math.exp(-n*3.4),this.pulse*=Math.exp(-n*2.15)),this.checkPerformance(e);let s=this.visualProgress(this.scrollCurrent);this.updateCamera(n,s),this.hero.update(this.elapsed,n,this.pointer,s,this.isMobile(),this.pulse,this.scrollVelocity),this.composer.update(this.elapsed,this.pulse,s,this.pointer,this.scrollVelocity),this.composer.render(r)};updateCamera(e,t=this.visualProgress(this.scrollCurrent)){let n=this.isMobile(),r=Lc(t,n),i=n?.035:.13;this.cameraTarget.copy(r.position),this.cameraTarget.x+=this.pointer.x*i,this.cameraTarget.y+=this.pointer.y*i*.7;let a=e===0?1:1-Math.exp(-e*3.2);this.camera.position.lerp(this.cameraTarget,a),this.lookTarget.copy(r.target),this.lookTarget.x+=this.pointer.x*.04,this.lookTarget.y+=this.pointer.y*.025,this.camera.lookAt(this.lookTarget);let o=r.fov;Math.abs(this.camera.fov-o)>.001&&(this.camera.fov=Me.lerp(this.camera.fov,o,a),this.camera.updateProjectionMatrix())}resetPerformanceSample(e=performance.now()){this.fpsFrames=0,this.fpsStartedAt=e}checkPerformance(e){if(this.quality===`low`)return;this.fpsFrames+=1;let t=e-this.fpsStartedAt;if(t<2800)return;let n=this.fpsFrames*1e3/t;n<46&&this.adaptiveScale>.66?(this.adaptiveScale=Math.max(.66,this.adaptiveScale-.12),this.recoverySamples=0,this.applyPixelRatio()):n>57&&this.adaptiveScale<1?(this.recoverySamples+=1,this.recoverySamples>=3&&(this.adaptiveScale=Math.min(1,this.adaptiveScale+.06),this.recoverySamples=0,this.applyPixelRatio())):this.recoverySamples=0,this.fpsFrames=0,this.fpsStartedAt=e}renderStaticFrame(){let e=this.options.reducedMotion?.82:this.scrollTarget,t=this.options.reducedMotion?e:this.visualProgress(e);this.scrollCurrent=e,this.updateCamera(0,t);let n=this.elapsed>0?this.elapsed:.8;this.hero.update(n,0,this.pointer,t,this.isMobile(),0,0),this.composer.update(n,0,t,this.pointer,0),this.composer.render(0)}isMobile(){let e=window.innerHeight>=window.innerWidth*.72;return window.innerWidth<760&&e}visualProgress(e){return .04+Me.clamp(e,0,1)*.96}applyPixelRatio(){let e=Xc(this.quality)*this.adaptiveScale;Math.abs(e-this.appliedPixelRatio)<.001||(this.appliedPixelRatio=e,this.renderer.setPixelRatio(e),this.composer.setPixelRatio(e),this.hero.setPixelRatio(e*this.composer.getRenderScale()))}resize=()=>{this.resizeFrame===0&&(this.resizeFrame=requestAnimationFrame(()=>{this.resizeFrame=0,this.applyResize()}))};applyResize(){let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/Math.max(t,1),this.camera.updateProjectionMatrix(),this.applyPixelRatio(),this.renderer.setSize(e,t,!1),this.composer.setSize(e,t),(this.options.reducedMotion||this.paused)&&this.renderStaticFrame()}stopLoop(){this.running=!1,cancelAnimationFrame(this.frameId)}togglePaused(){return this.options.reducedMotion||this.destroyed?!0:(this.paused=!this.paused,this.paused?this.stopLoop():(this.lastFrameTime=performance.now(),this.lastRenderTime=this.lastFrameTime,this.resetPerformanceSample(this.lastFrameTime),this.running=!0,this.frameId=requestAnimationFrame(this.tick)),this.paused)}destroy(){this.destroyed||(this.destroyed=!0,this.stopLoop(),cancelAnimationFrame(this.resizeFrame),window.removeEventListener(`resize`,this.resize),window.removeEventListener(`scroll`,this.updateScroll),window.removeEventListener(`pointermove`,this.handlePointer),window.removeEventListener(`pointerdown`,this.handleImpulse),window.removeEventListener(`pointerup`,this.handleRelease),window.removeEventListener(`pointercancel`,this.handleRelease),document.removeEventListener(`visibilitychange`,this.handleVisibility),document.documentElement.removeEventListener(`pointerleave`,this.resetPointer),this.canvas.removeEventListener(`webglcontextlost`,this.handleContextLost),this.canvas.removeEventListener(`webglcontextrestored`,this.handleContextRestored),this.hero.dispose(),this.composer.dispose(),this.renderer.dispose())}};export{Qc as Application};